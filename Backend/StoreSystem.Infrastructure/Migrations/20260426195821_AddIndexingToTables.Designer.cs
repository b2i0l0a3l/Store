...
namespace StoreSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260426195821_AddIndexingToTables")]
    partial class AddIndexingToTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreSystem.Core.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StoreSystem.Core.Entities.Notifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StoreSystem.Core.Entities.Order", b =>
                {
                    ...
                    b.ToTable("Orders", t =>
                        {
                            t.HasCheckConstraint("CK_Order_OrderStatus", "OrderStatus IN (0, 1, 2)");

                            t.HasCheckConstraint("CK_Order_OrderType", "OrderType IN (0, 1, 2)");
            ...
            modelBuilder.Entity("StoreSystem.Core.Entities.InvoiceItem", b =>
                {
                    b.HasOne("StoreSystem.Core.Entities.Invoice", "Invoice")
            ...
            modelBuilder.Entity("StoreSystem.Core.Entities.RefreshToken", b =>
                {
                    b.HasOne("StoreSystem.Core.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
